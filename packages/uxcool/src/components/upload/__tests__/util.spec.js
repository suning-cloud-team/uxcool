import { isXHRFileUpload, noop, attrAccept, traverseFileTree, handleFileList,normalizeFile, getFile, isImageUrl, isCanChunkUpload, BlobSlice, getChunkUploadBytes } from '../utils';
