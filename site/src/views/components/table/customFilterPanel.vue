  ...
  <ux-demo title="自定义筛选菜单"
    ...
    <div slot="desc">
      <p>
        ...
        <code>filterDropdownVisible</code> ,
        <code>onFilterDropdownVisibleChange</code>需配合使用
      </p>
    </div>
    <ux-code slot="code">
      {{ code }}
...
<script>
  import code from '@/code/table/customFilterPanel.vue';
    ...
    return [
      {
        ...
        // eslint-disable-next-line
        filterIcon(h) {
          return <ux-icon type="info_circle_o" />;
        },
